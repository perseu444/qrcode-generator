package com.jadermarcelo.qrcode.generator.service;
...
import com.jadermarcelo.qrcode.generator.ports.StoragePort;
...
public class QrCodeGeneratorService {
    ...
    public QrCodeGenerateResponse generateAndUploadQrCode(String text) throws WriterException, IOException {
        ...
        BitMatrix bitMatrix = qrCodeWriter.encode(text, BarcodeFormat.QR_CODE, 255, 255);
